...
@extend_schema(
    ...
    description="Returns a list of all projects in the current fiscal year with budget, spending, remaining, and progress info.",
...
def get_project_status_list(request):
    ...
    serializer = ProjectStatusSerializer(project_data, many=True)
    return Response(serializer.data)
