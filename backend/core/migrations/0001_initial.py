    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('FINANCE_HEAD', 'Finance Head'), ('FINANCE_OPERATOR', 'Finance Operator'), ('APPROVER', 'Approver'), ('VIEWER', 'Viewer'), ('ACCOUNTANT', 'Accountant')], max_length=20)),
