...
import ForgotPasswordPage from "./pages/Finance/ForgotPasswordPage"; // Path is correct
import ResetPasswordPage from "./pages/Finance/ResetPasswordPage"; // MODIFIED: Path updated
